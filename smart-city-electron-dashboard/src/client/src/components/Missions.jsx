    ...
    useEffect(() => {
        const fetchMissions = async () => {
            try {
                ...
                const statusCounts = { Completed: 0, Planned: 0, Failed: 0, Active: 0 };
                response.slice(0, 20).forEach((mission) => {
                    try {
        ...
        <Box>
            {showWaypoints ? (
                ...
                <Box sx={{ display: 'flex', height: '80vh' }}>
                    ...
                    <Box sx={{ flex: 2, padding: 0, color: "#fff" }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 2, color: "#fff" }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                <div style={{ backgroundColor: 'orange', width: '15px', height: '15px', marginRight: '5px' }}></div>
                    ...
                    {showCurrentMissions ? (
                        <Box sx={{ width: '30%', padding: '10px', color: '#fff' }}>
                            <Box sx={{ mb: "5px", mt: "5px" }}>
                                <Button variant="contained" color="secondary" onClick={handleCreateMission} >Create Mission</Button>
                            </Box>
                            <Box sx={{ color: '#fff', overflowY: 'auto', height: '80vh' }}>
                                            ...
                                            <Box sx={{ marginTop: '10px', padding: '10px', color: '#fff' }}>
                                                <Grid container spacing={2}>
                                                    ...
                                                    <Grid item xs={4}>
                                                        ...
                                                        <Typography variant="body2">{mission.drone_station_id}</Typography>
                                                    </Grid>
                                                    <Grid item xs={6}>
