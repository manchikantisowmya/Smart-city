...
export default function PersistentDrawerLeft(onLogout) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Divider />
        <List>
        {/* {['Satellite Data','IOT Station', 'Drone Station', 'Traffic Camera'].map((text, index) => ( */}
          {['Drone Station'].map((text, index) => (
