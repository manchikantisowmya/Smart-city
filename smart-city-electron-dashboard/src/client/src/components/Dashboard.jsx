...
export default function Dashboard() {
  ...
  const { routeCounts, timeIntervals, serviceDensity ={ estimated: [], groundTruth: [] } } = dashboardCCTVData || {};
    ...
    datasets: [
      {
        ...
        data: serviceDensity.estimated,
        borderColor: "blue",
        fill: true,
        tension: 0,
      },
      {
        label: "Ground Truth Density",
        data: serviceDensity.groundTruth,
        borderColor: "orange",
        fill: true,
        tension: 0,
      },
        ...
        {activeStatisticsTab === 0 && (
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <Card style={cardStyle}>
                <CardContent>
                  <Line data={lineData} options={line_options} height={300} width={50} />
                </CardContent>
              </Card>
            </Grid>
          </Grid>
        )}
        {activeStatisticsTab === 1 && (
          <Grid container spacing={2}>
            {/* CCTV Tab */}
            <Grid item xs={12} md={6}>
              <Card style={cardStyle}>
                <CardContent>
                  <Typography variant="h6" sx={{ color: "#B0E57C", marginBottom: "10px" }}>
                    Estimated vs Ground Truth Camera Density
                  </Typography>
                  <Line data={cctv_lineData} options={line_options} style={{ maxHeight: "400px" }} />
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} md={6}>
