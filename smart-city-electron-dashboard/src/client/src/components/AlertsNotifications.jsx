...
//     // Retrieve color from iconColors; default if not found
...
//         </svg>
//     );
//     const iconHTML = renderToStaticMarkup(iconSVG);
//     return L.divIcon({
//         html: iconHTML,
...
// const accidentLocations = [
//     { id: 1, type: 'Car on Fire', lat: 37.7749, lon: -122.4194 },
//     { id: 2, type: 'Collision', lat: 37.8044, lon: -122.2711 },
//     { id: 3, type: 'Truck Rollover', lat: 37.6879, lon: -122.4702 },
// ];

// const icons = {
//     'Car on Fire': `<svg fill="#e4d211" height="24px" width="24px" viewBox="0 0 379.766 379.766"><g><path d="..."></path></g></svg>`,
//     'Collision': `<svg fill="#c32828" height="24px" width="24px" viewBox="0 0 480.825 480.825"><g><path d="..."></path></g></svg>`,
//     'Truck Rollover': `<svg fill="#4caf50" height="24px" width="24px" viewBox="0 0 480.825 480.825"><g><path d="..."></path></g></svg>`,
// };
// const iconColors = {
//     default: '#FFFFFF', // Example color for default case
//     primary: '#4CAF50', // Example color for primary state
//     error: '#FF0000', // Example color for error state
//     // Add more colors as needed
// };

// accidentLocations.forEach(location => {
//     const iconMarkup = icons[location.type];
...
const AlertAndNotification = () => {
    ...
    //     setVideoFinished(true); // Video has finished playing
    // };
...
{/* <Grid item xs={3}>
    ...
    {/*} <Grid item xs={3}>
        ...
        {activeTab === 0 && (
             ...
             <Grid item xs={3}>
            <Card style={{ backgroundColor: '#dcbb14', height: '125px', marginTop:'-2px',marginBottom:'10px',color: 'white', padding: '10px', textAlign: 'center', borderRadius: '10px' }}>
                <CardContent>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <CarCrashIcon />
                        <Typography variant="h6">Car on Fire in Nov 2024 <br /><b>14</b></Typography>
                    </div>
                </CardContent>
            </Card>
            <Card style={{ backgroundColor: '#e92929', height: '125px',marginBottom:'10px', color: 'white', padding: '10px', textAlign: 'center', borderRadius: '10px' }}>
                <CardContent>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <CarCrashIcon />
                        <Typography variant="h6"> Car Collision in Nov 2024 <br /><b>14</b></Typography>
                    </div>
                </CardContent>
            </Card>
            <Card style={{ backgroundColor: '#4067b6', height: '125px', marginBottom:'10px', color: 'white', padding: '10px', textAlign: 'center', borderRadius: '10px' }}>
                <CardContent>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <CarCrashIcon />
                        <Typography variant="h6">Truck Rollover in Nov 2024 <br /><b>14</b></Typography>
                    </div>
                </CardContent>
            </Card>
        </Grid> 
        ...
        <DialogActions>
            ...
            {activeTab === 1 && (
                <Grid container spacing={2}>
                                     {/* Graph Content */}
                                     <Grid item xs={6}> 
                                         <Line  style={{ height: '40vh' , border: '1px solid grey',}} data={data} options={options} />
                                     </Grid>
                                     <Grid item xs={6}>
                                         <Bar  style={{ height: '40vh' , border: '1px solid grey',}} data={datastack} options={optionsstack} />
                                      </Grid>
                                     <Grid item xs={6}>
                                         <Bar   style={{ height: '40vh' , border: '1px solid grey',}} data={dataheat} options={optionsheat} />
                                     </Grid>
                                </Grid>
            )}
        </Grid>
