...
def fetch_mission_details_from_database(mission_id):
    ...
    url = "http://localhost:5002/api/auth/getonemission1/{}".format(mission_id)
...
cleanedString = mission_details["mission_waypoints"][0].replace('\\"', '"');
waypoints = json.loads(cleanedString);
print(waypoints)
waypoint_0_lat = waypoints[0]['lat']
waypoint_0_long =waypoints[0]['long']
